.DEFAULT_GOAL := help
.PHONY: help install install-docs install-viz lint format format-check pre-commit \
...
help:  ## Show this help message
	@printf "$(BOLD)MaldiBatchKit - available targets$(RESET)\n\n"
...
install-viz:  ## Install package with visualisation dependencies
	@pip install -e ".[viz]"
